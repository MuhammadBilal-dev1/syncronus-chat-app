...
function CommandGroup({ className, ...props }) {
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium bg-white text-black",
        className
      )}
      {...props}
    />
